...
const IntroOverlay: React.FC<IntroOverlayProps> = ({ isExiting }) => {
  return (
    <div
      className={`fixed inset-0 z-[10000] flex items-center justify-center bg-pop-blue text-white overflow-hidden transition-transform duration-700 ease-[cubic-bezier(0.76,0,0.24,1)] ${isExiting ? '-translate-y-full' : 'translate-y-0'}`}
    >
      <div className="relative flex flex-col items-center w-full max-w-md px-6 animate-scale-in">
         <h1 className="text-6xl md:text-9xl font-display font-black tracking-tighter text-center">
            HABITAT
         </h1>
