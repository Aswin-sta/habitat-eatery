                ...
                >
                    ...
                    <div className="flex flex-col items-center relative z-10">
                        ...
                        <h2 className="text-3xl md:text-7xl lg:text-8xl font-display font-black leading-[0.95] mb-6 md:mb-12 text-pop-dark uppercase tracking-tight break-words w-full">
                            We Craft Flavors <br/>
                            <span className="text-pop-blue inline-block transform -rotate-1 decoration-wavy underline decoration-pop-yellow decoration-4 underline-offset-8">That Spark Joy.</span>
                        </h2>

                        <p className="font-sans text-base md:text-2xl font-medium text-gray-700 max-w-3xl mx-auto leading-relaxed mb-4 md:mb-8">
                            No stiff suits. No tiny portions. Just bold taste, good vibes, and a whole lot of color. We believe food is the ultimate storyteller.
                        </p>
                    </div>
