...
const ContactCard: React.FC<ContactCardProps> = ({ option, isMobile = false, copied, onCopy, onHover }) => {
...
const InfoCard = ({ isMobile = false }: { isMobile?: boolean }) => (
    ...
    `}>
        <div>
            ...
            <h4 className="font-display font-black uppercase text-lg md:text-xl mb-1">{BUSINESS_INFO.addressLabel}</h4>
            <p className="font-sans font-medium text-sm md:text-base text-gray-600">{BUSINESS_INFO.address}</p>
        </div>
        ...
        <div>
            ...
            <p className="font-sans font-medium text-sm md:text-base text-gray-600">{BUSINESS_INFO.hours}</p>
        </div>
    </div>
);
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
            ...
            <div className="flex flex-col items-center mb-20 text-center">
                ...
                <h2 className="text-9xl font-display font-black uppercase leading-[0.85] tracking-tighter mb-8 text-pop-dark">
                    Signal <span className="text-transparent stroke-text" style={{ WebkitTextStroke: "2px black" }}>Us</span>
                </h2>
                
                <p className="font-sans text-xl font-medium max-w-2xl text-gray-600">
                    Choose your frequency. Our team is standing by to secure your habitat.
                </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-8">
                 <div className="bg-white border-4 border-black rounded-[2.5rem] p-8 flex items-center gap-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all">
                     ...
                     <div>
                         <h4 className="font-display font-black uppercase text-2xl mb-1">{BUSINESS_INFO.addressLabel}</h4>
                         <p className="font-sans font-medium text-lg text-gray-600">{BUSINESS_INFO.address}</p>
                     </div>
                 </div>
                 <div className="bg-white border-4 border-black rounded-[2.5rem] p-8 flex items-center gap-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all">
                     ...
                     <div>
                         ...
                         <p className="font-sans font-medium text-lg text-gray-600">{BUSINESS_INFO.hours}</p>
                     </div>
                 </div>
            </div>
        </div>
         ...
         <div className="sticky top-0 h-screen overflow-hidden flex flex-col justify-end pb-12">
             ...
             <div className="absolute top-0 left-0 w-full p-4 pt-20 z-0 pointer-events-none">
                ...
                <h2 className="text-[12vw] font-display font-black uppercase leading-[0.85] tracking-tighter text-pop-dark">
                    Signal <span className="text-transparent stroke-text" style={{ WebkitTextStroke: "1px black" }}>Us</span>
                </h2>
             </div>
